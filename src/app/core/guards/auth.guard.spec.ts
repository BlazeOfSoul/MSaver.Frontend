...
describe('authGuard', () => {
    ...
    it('allows navigation immediately when a session is already in memory', () => {
    ...
    it('restores the session from auth cookies before allowing protected navigation', async () => {
    ...
    it('redirects to auth when cookie session restoration fails', async () => {
